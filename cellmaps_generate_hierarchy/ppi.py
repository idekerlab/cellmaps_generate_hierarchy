...
class PPINetworkGenerator(object):
    ...
    def get_network(self, cutoff=0.01):

        """
        Gets protein to protein interaction network
...
class CosineSimilarityPPIGenerator(PPINetworkGenerator):
    ...
    def __init__(self, embeddingfile=None):
        ...
        if embeddingfile is None:
            raise CellmapsGenerateHierarchyError('embedding file is None')

        self._embeddingfile = embeddingfile
